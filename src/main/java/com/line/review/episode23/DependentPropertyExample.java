...
public class DependentPropertyExample {
    
    /**
     * Bad 버전: 무의미한 대입을 배제하기 위한 조기 반환
     */
    public void updateTextViewBad(TextView textView, String someText) {
        if (someText.isEmpty()) {
     ...
     */
    public void updateTextViewGood(TextView textView, String someText) {
        textView.isVisible = !someText.isEmpty();
        textView.text = someText;
    }
}
