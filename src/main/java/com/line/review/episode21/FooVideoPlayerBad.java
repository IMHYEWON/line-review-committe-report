 ...
 */
public class FooVideoPlayerBad {
    private final Uri videoUri;
    private PreparedValue preparedValue;

    public FooVideoPlayerBad(Uri videoUri) {
    ...
    public void prepare() {
        ...
        preparedValue = new PreparedValue("prepared-" + videoUri.value());
    }
     ...
     */
    public void play() {
        PreparedValue currentValue = preparedValue;
        if (currentValue == null) {
            throw new IllegalStateException("Not prepared yet");
        }

        // ... play `videoUri`.
        System.out.println("Playing video: " + videoUri.value() + " with " + currentValue.data());
    }
}
